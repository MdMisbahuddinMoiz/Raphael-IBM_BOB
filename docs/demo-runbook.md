...
Verified result: **Ran 459 tests — OK (0 failed)** (M15.3). Expected
...
specialization layer, `docs/http-api.md` covers the M15.1 HTTP/JSON
presentation layer, and `docs/decision-trace.md` covers the M15.3
read-only Decision Trace operator screen
(`GET /operations/{run_id}/decision-trace`). Verified live run:
