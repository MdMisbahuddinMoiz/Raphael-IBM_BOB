...
BROKER_SPECS = (
    AdapterSpec(
        ...
        m7_status="M7: unchanged from M6.",
    ),
    AdapterSpec(
...
EVIDENCE_SPECS = (
    AdapterSpec(
        ...
        missing_for_target="JSONL append-only + flat causal links (M3+M4+M6).",
        m6_status="M6: EvidenceLedger now also persists GateRecord for QualityGate decisions.",
        m7_status="M7: unchanged from M6.",
    ),
    AdapterSpec(
        ...
        missing_for_target="BOB uses 'producer' string tag.",
        m6_status="M6: ISOLATE remains correct. New producers: 'probe', 'regression'.",
        m7_status="M7: ISOLATE remains correct.",
    ),
)
...
FALSIFIER_SPECS = (
    AdapterSpec(
        ...
        legacy_behavior_remaining="Offensive contradictions.",
        missing_for_target="Counter-example observed through Broker, persisted as EvidenceRecord.",
        m6_status="M6: Falsifier unchanged from M5.",
        m7_status="M7: unchanged from M6.",
    ),
)
